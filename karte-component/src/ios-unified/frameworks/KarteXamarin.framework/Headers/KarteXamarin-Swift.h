...
#ifndef KARTEXAMARIN_SWIFT_H
#define KARTEXAMARIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KarteXamarin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSString;
@class KRTConfigurationXamarin;
@class UIApplication;
@class NSURL;

SWIFT_CLASS_NAMED("KarteAppXamarin")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) KRTConfigurationXamarin * _Nonnull configuration;)
+ (KRTConfigurationXamarin * _Nonnull)configuration SWIFT_WARN_UNUSED_RESULT;
...
+ (void)setLogLevelWithLogLevel:(enum KRTLogLevel)logLevel;
...
SWIFT_CLASS_NAMED("KarteConfigurationXamarin")
...
SWIFT_PROTOCOL_NAMED("KarteIDFADelegateXamarin")
@protocol KRTIDFADelegateXamarin <KRTIDFADelegate>
...
@class UIView;
@class KRTTrackingTaskXamarin;
@class NSDictionary;

SWIFT_CLASS_NAMED("TrackerXamarin")
...
+ (KRTTrackingTaskXamarin * _Nonnull)attribute:(NSDictionary * _Nonnull)values;
...
SWIFT_CLASS_NAMED("TrackingTaskXamarin")
...
SWIFT_CLASS_NAMED("UserSyncXamarin")
